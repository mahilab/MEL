...
private:
    ...
    OutputModule<voltage>::Channel ao_channel_; ///< the DAQ analog output channel bound to this Motor (for commanding torque/current)
    OutputModule<logic>::Channel do_channel_;   ///< the DAQ digital output channel bound to this Motor (for enable/disable)
    InputModule<voltage>::Channel ai_channel_;  ///< the DAQ analog input channel bound to this Motor (for current sensing)
