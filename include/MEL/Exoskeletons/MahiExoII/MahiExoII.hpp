...
namespace mel {
    ...
    public:
        ...
        public:
            ...
            void start(std::vector<double> current_pos, double current_time);
            void start(std::vector<double> ref_pos, std::vector<double> current_pos, double current_time);
            void set_ref(std::vector<double> ref_pos, double current_time);
        ...
        std::vector<double> set_rps_pos_ctrl_torques(SmoothReferenceTrajectory& rps_ref, double current_time);
        ...
        std::vector<double> set_anat_pos_ctrl_torques(SmoothReferenceTrajectory& anat_ref, double current_time);
    ...
    private:
        ...
        const std::vector<double> rps_par_joint_speed_ = { 0.015, 0.015, 0.015 };
        const std::vector<double> rps_ser_joint_speed_ = { 0.125, 0.125, 0.015 };
