...
2) Run the VS2017 installer and check the following options:
   ...
   -Desktop developemnt with C++

   Under the Individiual components Tab:
...
2) Choose "Clone a respository" and enter the following URL:

   https://github.com/epezent/MEL

   Set the local path to C:\whatever\you\like\MEL
	
3) Clone the respository. Navigate to the local path in Windows Explorer and
