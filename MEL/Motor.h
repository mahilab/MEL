...
namespace mel {
    ...
    public:
        ...
        Motor(std::string name, double kt, double amp_gain, Daq::Ao ao_channel,
            double current_limit, double torque_limit, bool saturate = true);
        ...
        /// Gets last commanded current, checks it against current limit, and returns true if exceeded, false otherise
        bool check_current_limit();
