...
namespace mel {
    ...
    public:
        ...
        struct Params {
            ...
            std::array<double, 3> pos_limits_neg_       = { -86.1123 * DEG2RAD, -63.2490 * DEG2RAD, -42.0321 * DEG2RAD }; ///< joint position limits in negative rotation [rad]
            std::array<double, 3> pos_limits_pos_       = { +86.1123 * DEG2RAD, +68.2490 * DEG2RAD, +30.9087 * DEG2RAD }; ///< joint position limits in positive rotation [rad]
