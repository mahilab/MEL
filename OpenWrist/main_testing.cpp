...
class MyController : public mel::Controller {
    ...
    void start() override {
        ...
        mel::Daq::DoChannel do0 = q8->do_channel(0);
        std::cout << q8->num_do_channels_ << " " << std::endl;
        mel::print_uint_vec(q8->do_channels_nums_);
        do0.set_state(1);
        q8->write_all();
        mel::Daq::DoChannel do3 = q8->do_channel(3);
        do3.set_state(1);
