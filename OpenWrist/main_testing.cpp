...
class MyController : public mel::Controller {
    ...
    void start() override {
        ...
        std::string id = "0";
        mel::uint_vec  ai_channels = { 0, 1, 2, 3 };
        mel::uint_vec  ao_channels = { 0, 1, 2, 3 };
        mel::uint_vec  di_channels = { 0, 1, 2, 3 };
        mel::uint_vec  do_channels = { 0, 1, 2, 3 };
        mel::uint_vec enc_channels = { 0, 1, 2, 3 };
