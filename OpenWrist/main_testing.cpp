...
class MyController : public mel::Controller {
    ...
    void start() override {
        ...
        std::string id = "0";
        mel::uint32_vec  ai_channels = { 0, 1, 2, 3 };
        mel::uint32_vec  ao_channels = { 0, 1, 2, 3 };
        mel::uint32_vec  di_channels = { 0, 1, 2, 3 };
        mel::uint32_vec  do_channels = { 0, 1, 2, 3 };
        mel::uint32_vec enc_channels = { 0, 1, 2, 3 };
